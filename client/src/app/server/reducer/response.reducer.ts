...
const responseSlice = createSlice({
    ...
    extraReducers(builder) {
        ...
        builder.addCase(eventAction.updatePlayerDataAction.pending, (state) => {
            state.loading = true
        })
        builder.addCase(eventAction.updatePlayerDataAction.fulfilled, (state) => {
            state.loading = false
        })
        ...
        builder.addCase(eventAction.createStatisticAction.pending, (state) => {
            state.loading = true
        })
        builder.addCase(eventAction.createStatisticAction.fulfilled, (state) => {
            state.loading = false
        })
