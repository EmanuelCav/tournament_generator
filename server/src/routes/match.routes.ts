...
import updateScoreValid from "../middleware/validation/validation/score.valid";
...
router.put('/score/matchs/:mid/events/:eid', auth, updateScoreValid, matchCtrl.updateScore)
